...
public class MyContentProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI("pl.studia.hour19.provider", "pie", 1);
        sUriMatcher.addURI("pl.studia.hour19.provider/#", "pie", 2);
    }

    public static final Uri CONTENT_URI = Uri.parse("content://pl.studia.hour19.provider/pie");
    ...
    public String getType(Uri uri) {
        ...
        switch (uriType) {
            case 1:
                return ContentResolver.CURSOR_DIR_BASE_TYPE + "/pl.studia.hour19.Pie";
            case 2:
                return ContentResolver.CURSOR_ITEM_BASE_TYPE + "/pl.studia.hour19.Pie";
            default:
                return null;
        }
    }
